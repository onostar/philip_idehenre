...
<html lang="en">
    <head>
        ...
        <title>Health care | Philip Idehenre Foundation</title>
...
<body>
            ...
            <div class="about_banner">
                <div class="slide">
                    <div class="banner_img">
                        <img src="images/humanitarian2.jpg" alt="banner">
                    </div>
                    <div class="taglines">
    ...
    <main>
        <section id="existence">
            <h2>Health care</h2>
            <hr>
            <h3>Providing health care access</h3>
            <div class="story">
                <p id="first_story">At <strong>Philip Idehenre Foundation</strong>, we are strive to provide access to good health care services for the less privilege (wiidows and children).<br><br>
                With our partnership with several top hospitals across the nation, We look to use this opportunity to improve the health of those who cannot afford medication.<br><br>
                Join us today to help save lifes.<br>
                    <a id="invest_link" href="contact.php" title="contact us">Join us <i class="fas fa-hand-fist"></i></a>
                </p>
                <div class="more_notes">
                    <img src="images/humanitarian2.jpg" alt="banner2">
