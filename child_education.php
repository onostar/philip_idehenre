...
<html lang="en">
    <head>
        ...
        <title>Child Education | Philip Idehenre Foundation</title>
...
<body>
            ...
            <div class="about_banner">
                <div class="slide">
                    <div class="banner_img">
                        <img src="images/school_kids.jpg" alt="about us">
                    </div>
                    <div class="taglines">
    ...
    <main>
        <section id="existence">
            <h2>Child Education</h2>
            <hr>
            <h3>Providing Education for the helpless child</h3>
            <div class="story">
                ...
                We look to improve the lives of helpless children across areas in Nigeria by giving scholarships to over 2000 helpless children across the nation.<br><br>
                ...
                <div class="more_notes">
                    <img src="images/school_children.jpg" alt="child education">
