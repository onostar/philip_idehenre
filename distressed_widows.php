...
<html lang="en">
    <head>
        ...
        <title>Distressed widows | Philip Idehenre Foundation</title>
...
<body>
            ...
            <div class="about_banner">
                <div class="slide">
                    <div class="banner_img">
                        <img src="images/women3.jpg" alt="banner">
                    </div>
                    <div class="taglines">
                        <h2>Helping the Distressed Widows</h2>
    ...
    <main>
        <section id="existence">
            <h2>Distressed Widows and Children</h2>
            <hr>
            <h3>Providing care for the distressed</h3>
            <div class="story">
                <p id="first_story">At <strong>Philip Idehenre Foundation</strong>, we are determined to improve the livelihood of helpless widows and children across Nigeria and beyond by giving access to good healthcare, skill acquisition prgrammes and scholarships.<br><br>
                We look to improve the lives of helpless widows by encouraging and supporting them psychologically and otherwise. We also look to bring out helpless children from the street and give them a meaningful life<br><br>
                Join us today to help save our future by giving quality education to these children who deserves it.<br>
                    <img src="images/women3.jpg" alt="banner">
                    <a id="invest_link" href="contact.php" title="contact us">Join us <i class="fas fa-hand-fist"></i></a>
                </p>
                <div class="more_notes">
                    <img src="images/help_children.jpg" alt="banner2">
